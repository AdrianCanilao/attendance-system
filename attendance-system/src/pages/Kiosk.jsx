...
const styles = {
  ...
  successBox: { marginTop: "0", height: "100%", padding: "14px 18px", borderRadius: "14px", background: "#ecfdf5", border: "2px solid #22c55e", boxSizing: "border-box", overflow: "hidden", display: "flex", flexDirection: "column", justifyContent: "center", flexShrink: 0 },
